	...
	private void InitializeGUI() {
		...
		btnRun.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				buffer = new CharacterBuffer(listR, listW);
				if (writer == null) {
					writer = new Writer(buffer, txtTrans.getText(), listW, bSync.isSelected(), lblTrans);
					reader = new Reader(buffer, listR, bSync.isSelected(), lblRec);
					reader.start();
					writer.start();
				} else {
					writer = null;
