	...
	private void InitializeGUI()
	{
		...
		btnOpen.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				Buffer buffer = new Buffer(lblWadv, lblWcom, lblAdvNr, lblComNr, lblAexit, lblCexit);
				new Reception(buffer);
				new AdventurePool(buffer);
				new CommonPool(buffer);
				new Exit(buffer);
			}
		});
		pnlRec.add(btnOpen);
